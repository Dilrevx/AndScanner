...
class TestEngine(object):
    ...
    def loadTestSuites(self):
        ...
        allTestSuites = json.load(open("/data/mcl_workspace/android_patch_check_2302/assets/allTestSuites.json"))
        ...
        basicTestChunks = [
            "/data/mcl_workspace/android_patch_check_2302/" + url.replace("https://snoopsnitch-api.srlabs.de", "assets")
