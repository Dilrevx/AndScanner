...
class TestEngine(object):
    ...
    def loadTestSuites(self):
        ...
        allTestSuites = json.load(open("./android_patch_check/assets/allTestSuites.json"))
        ...
        basicTestChunks = [
            "./andpatchchecker/android_patch_check/" + url.replace("https://snoopsnitch-api.srlabs.de", "assets")
