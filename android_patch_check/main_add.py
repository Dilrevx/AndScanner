...
def brand_cve_check(rom_path):
    ...
    if os.path.isfile(prop_path) == False:
        prop_path = (
            rom_path + "/payload.bin.extracted/system.img.extracted/system/build.prop"
        )
    ...
    if (
        ...
        if prop_path.endswith(
            "/payload.bin.extracted/system.img.extracted/system/build.prop"
        ):
            order2 = (
                "cp -r "
                + rom_path
                + "/payload.bin.extracted/system_ext.img.extracted/* "
                + check_path
                + "/system/system_ext/"
            )
            ...
            order2 = (
                "cp -r "
                + rom_path
                + "/system_ext.img.extracted/system/* "
                + check_path
                + "/system/system_ext/"
            )
        else:
